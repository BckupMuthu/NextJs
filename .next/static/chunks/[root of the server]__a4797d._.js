(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/[root of the server]__a4797d._.js", {
...
"[project]/pages/game.js [client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function game() {
    ...
    const [basketPosition, setBasketPosition] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(250);
    ...
    const gameContainerRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    // Game Logic - Start the game
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "game.useEffect": ()=>{
            if (gameOver) return;
            // Add items to the screen every 1.5 seconds
            const itemInterval = setInterval({
                "game.useEffect.itemInterval": ()=>{
                    if (gameOver) clearInterval(itemInterval);
                    const randomX = Math.floor(Math.random() * 400);
                    setItems({
                        "game.useEffect.itemInterval": (prevItems)=>[
                                ...prevItems,
                                {
                                    x: randomX,
                                    y: 0,
            ...
            }["game.useEffect.itemInterval"], 1500);
            // Move the falling items
            const gameInterval = setInterval({
                "game.useEffect.gameInterval": ()=>{
                    if (gameOver) clearInterval(gameInterval);
                    setItems({
                        "game.useEffect.gameInterval": (prevItems)=>{
                            const newItems = prevItems.map({
                                "game.useEffect.gameInterval.newItems": (item)=>({
                                        ...item,
                                        y: item.y + 5
                                    })
                            }["game.useEffect.gameInterval.newItems"]);
                            // Check for collisions with basket
                            newItems.forEach({
                                "game.useEffect.gameInterval": (item)=>{
                                    if (item.y > 400 && item.y < 430 && item.x >= basketPosition && item.x <= basketPosition + 50) {
                                        setScore({
                                            "game.useEffect.gameInterval": (prevScore)=>prevScore + item.points
                                        }["game.useEffect.gameInterval"]); // Increment score
                                        setItems({
                                            "game.useEffect.gameInterval": (prevItems)=>prevItems.filter({
                                                    "game.useEffect.gameInterval": (i)=>i !== item
                                                }["game.useEffect.gameInterval"])
                                        }["game.useEffect.gameInterval"]); // Remove item after catching
                                    }
                                    // Game Over if no more lives
                                    if (item.y > 450) {
                                        setLives({
                                            "game.useEffect.gameInterval": (prevLives)=>prevLives - 1
                                        }["game.useEffect.gameInterval"]);
                                        if (lives <= 1) setGameOver(true); // End game if no lives left
                                        setItems({
                                            "game.useEffect.gameInterval": (prevItems)=>prevItems.filter({
                                                    "game.useEffect.gameInterval": (i)=>i !== item
                                                }["game.useEffect.gameInterval"])
                                        }["game.useEffect.gameInterval"]); // Remove item after missing
                                    }
                                }
                            }["game.useEffect.gameInterval"]);
                            return newItems;
            ...
            }["game.useEffect.gameInterval"], 50);
            return ({
                "game.useEffect": ()=>{
    ...
    // Handle keyboard input to move the basket left and right
    const moveBasket = (e)=>{
        if (gameOver) return;
        if (e.key === 'ArrowLeft' && basketPosition > 0) {
            setBasketPosition((prevPosition)=>prevPosition - 10);
        } else if (e.key === 'ArrowRight' && basketPosition < 400) {
            setBasketPosition((prevPosition)=>prevPosition + 10);
        }
    };
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "game.useEffect": ()=>{
            ...
            return ({
                "game.useEffect": ()=>{
                    window.removeEventListener('keydown', moveBasket);
                }
            })["game.useEffect"];
        }
    }["game.useEffect"], [
    ...
    const restartGame = ()=>{
        ...
        setGameOver(false);
        setItems([]);
        localStorage.setItem('gameScore', 0); // Reset score in localStorage on restart
    };
    // Store score in localStorage when game ends
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "game.useEffect": ()=>{
            if (gameOver) {
                localStorage.setItem('gameScore', score); // Store score in localStorage when game ends
            }
        }
    }["game.useEffect"], [
        gameOver,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                children: "Catch the Item Game"
            }, void 0, false, {
                fileName: "[project]/pages/game.js",
                lineNumber: 98,
                columnNumber: 7
            }, this),
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    items.map((item, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "item",
                            style: {
                                left: `${item.x}px`,
                                top: `${item.y}px`
...
_s(game, "SJNH71pezOAn7NamAxcyOJW+MmQ=");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$pages$2f$game$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/pages/game.js [client] (ecmascript)");
...
function Home() {
    ...
    // Redirect to the game page when the user lands on the index page
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            router.push("/game");
        }
    ...
    // Retrieve the score from localStorage and calculate the discount
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            ...
            if (storedScore) {
                ...
                setScore(gameScore);
                // Calculate discount based on score, max 500 points
                const calculatedDiscount = Math.min(gameScore, 500) * 0.2; // 20% discount per 100 points
...
_s(Home, "SlWynU9Z5+Fuw6QXDYFG8oRmTI4=", false, function() {
    return [
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__a4797d._.js.map