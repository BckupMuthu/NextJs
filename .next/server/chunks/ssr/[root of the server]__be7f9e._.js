...
"[project]/pages/game.js [ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function game() {
    ...
    const [basketPosition, setBasketPosition] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])(250);
    ...
    const gameContainerRef = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useRef"])(null);
            ...
            setItems((prevItems)=>{
                ...
                newItems.forEach((item)=>{
                    if (item.y > 400 && item.y < 430 && item.x >= basketPosition && item.x <= basketPosition + 50) {
                        setScore((prevScore)=>prevScore + item.points); // Increment score
                        setItems((prevItems)=>prevItems.filter((i)=>i !== item)); // Remove item after catching
                    }
                    // Game Over if no more lives
                    if (item.y > 450) {
                        setLives((prevLives)=>prevLives - 1);
                        if (lives <= 1) setGameOver(true); // End game if no lives left
                        setItems((prevItems)=>prevItems.filter((i)=>i !== item)); // Remove item after missing
                    }
                });
                return newItems;
            });
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    items.map((item, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                            className: "item",
                            style: {
                                left: `${item.x}px`,
                                top: `${item.y}px`
...
var __TURBOPACK__imported__module__$5b$project$5d2f$pages$2f$game$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/pages/game.js [ssr] (ecmascript)");
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__be7f9e._.js.map